    ...
    public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer player, int par6, float par7, float par8, float par9)
    {
        ...
        else if (!player.isSneaking())
        {
            ...
            if (tileentityfurnace != null)
            {
                ...
                {
                case 1:
                    player.openGui(MadScience.instance, MadFurnaces.SONICLOCATOR_TILEENTITY.blockID, world, x, y - 1, z);
                    break;
                case 2:
                    player.openGui(MadScience.instance, MadFurnaces.SONICLOCATOR_TILEENTITY.blockID, world, x, y - 2, z);
                    break;
                }
            }
            return true;
