...
public class SoniclocatorGUI extends GuiContainer
{
    // Texture of the GUI interface that holds all the controls.
    private static final ResourceLocation furnaceGuiTextures = new ResourceLocation(MadScience.ID, "textures/gui/" + MadFurnaces.SONICLOCATOR_INTERNALNAME + ".png");

    private SoniclocatorEntity furnaceInventory;
