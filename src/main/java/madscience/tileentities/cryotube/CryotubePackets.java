...
public class CryotubePackets extends MadPackets
{
    ...
    public CryotubePackets(int posX, int posY, int posZ,
            int hatchTime, int hatchTimeMax,
            long energyStored, long energyMax,
            int subjectHealth, int subjectMaxHealth,
            int neuralActivity, int neuralActivityMax,
            String tileTexture)
    {
    ...
    public void execute(EntityPlayer player, Side side) throws ProtocolException
    {
        ...
        if (side.isClient())
        {
            ...
            if (cryoTubeTileEntity == null) return;
