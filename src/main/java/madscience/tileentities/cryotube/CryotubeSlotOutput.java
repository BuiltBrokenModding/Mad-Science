...
public class CryotubeSlotOutput extends Slot
{
    private int field_75228_b;
    /** The player that is using the GUI where this slot resides. */
    private EntityPlayer thePlayer;

    public CryotubeSlotOutput(EntityPlayer par1EntityPlayer, IInventory par2IInventory, int par3, int par4, int par5)
    {
