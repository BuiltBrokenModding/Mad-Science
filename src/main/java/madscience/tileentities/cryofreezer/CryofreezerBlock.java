...
public class CryofreezerBlock extends BlockContainer
{
    ...
    public CryofreezerBlock(int id)
    {
    ...
    public void breakBlock(World par1World, int par2, int par3, int par4, int par5, int par6)
    {
        ...
        {
            CryofreezerEntity tileentityfurnace = (CryofreezerEntity) par1World.getBlockTileEntity(par2, par3, par4);
    ...
    {
        return MadFurnaces.CRYOFREEZER_TILEENTITY.blockID;
    }
    ...
    public void onBlockPlacedBy(World world, int x, int y, int z, EntityLivingBase living, ItemStack stack)
    {
        ...
        lastPlacedTileEntity = (CryofreezerEntity) world.getBlockTileEntity(x, y, z);
    ...
    {
        this.blockIcon = icon.registerIcon(MadScience.ID + ":" + MadFurnaces.CRYOFREEZER_INTERNALNAME);
    }
