...
public class IncubatorBlock extends BlockContainer
{
    ...
    public void breakBlock(World par1World, int par2, int par3, int par4, int par5, int par6)
    {
        ...
        {
            IncubatorEntity tileentityfurnace = (IncubatorEntity) par1World.getBlockTileEntity(par2, par3, par4);
    ...
    {
        return MadFurnaces.INCUBATOR_TILEENTITY.blockID;
    }
    ...
    {
        this.blockIcon = icon.registerIcon(MadScience.ID + ":" + MadFurnaces.INCUBATOR_INTERNALNAME);
    }
