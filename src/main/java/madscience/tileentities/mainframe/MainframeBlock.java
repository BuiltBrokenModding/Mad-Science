...
public class MainframeBlock extends BlockContainer
{
    ...
    public void breakBlock(World par1World, int par2, int par3, int par4, int par5, int par6)
    {
        ...
        {
            MainframeEntity tileentityfurnace = (MainframeEntity) par1World.getBlockTileEntity(par2, par3, par4);
    ...
    {
        return MadFurnaces.MAINFRAME_TILEENTITY.blockID;
    }
    ...
    public void onBlockPlacedBy(World world, int x, int y, int z, EntityLivingBase living, ItemStack stack)
    {
        ...
        lastPlacedTileEntity = (MainframeEntity) world.getBlockTileEntity(x, y, z);
    ...
    {
        this.blockIcon = icon.registerIcon(MadScience.ID + ":" + MadFurnaces.MAINFRAME_INTERNALNAME);
    }
