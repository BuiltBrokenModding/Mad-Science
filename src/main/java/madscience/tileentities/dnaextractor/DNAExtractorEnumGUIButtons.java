...
public enum DNAExtractorEnumGUIButtons implements MadGUIButtonInterface
{
    ...
    DNAExtractorEnumGUIButtons(MadGUIButtonTypeEnum buttonType, MadGUIButtonClickActionEnum clickAction, Object userData, int screenX, int screenY, int fillX, int fillY, int sizeX, int sizeY)
    {
