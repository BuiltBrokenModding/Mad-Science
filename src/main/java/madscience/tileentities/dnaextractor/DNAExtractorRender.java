...
public class DNAExtractorRender extends TileEntitySpecialRenderer implements ISimpleBlockRenderingHandler, IItemRenderer
{
    ...
    private DNAExtractorModel model;
    ...
    private ResourceLocation defaultDNAExtractorTexture = new ResourceLocation(MadScience.ID, "models/" + MadFurnaces.DNAEXTRACTOR_INTERNALNAME + "/idle.png");

    // Reference to our tile entity.
    private DNAExtractorEntity lastPlacedTileEntity;

    public DNAExtractorRender()
    {
        this.model = new DNAExtractorModel();
    }
    ...
    public void renderItem(ItemRenderType type, ItemStack item, Object... data)
    {
        ...
        Minecraft.getMinecraft().renderEngine.bindTexture(defaultDNAExtractorTexture);
    ...
    public void renderTileEntityAt(TileEntity tileEntity, double x, double y, double z, float scale)
    {
        ...
        else
        {
            ...
            bindTexture(defaultDNAExtractorTexture);
        }
