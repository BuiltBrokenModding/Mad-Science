...
public class VoxBoxBlock extends BlockContainer
{
    ...
    private VoxBoxEntity lastPlacedTileEntity;

    public VoxBoxBlock(int id)
    {
    ...
    public void breakBlock(World par1World, int par2, int par3, int par4, int par5, int par6)
    {
        ...
        {
            VoxBoxEntity tileentityfurnace = (VoxBoxEntity) par1World.getBlockTileEntity(par2, par3, par4);
    ...
    {
        return MadFurnaces.VOXBOX_TILEENTITY.blockID;
    }
    ...
    public void onBlockPlacedBy(World world, int x, int y, int z, EntityLivingBase living, ItemStack stack)
    {
        ...
        lastPlacedTileEntity = (VoxBoxEntity) world.getBlockTileEntity(x, y, z);
    ...
    {
        this.blockIcon = icon.registerIcon(MadScience.ID + ":" + MadFurnaces.VOXBOX_INTERNALNAME);
    }
