...
public class ThermosonicBonderRender extends TileEntitySpecialRenderer implements ISimpleBlockRenderingHandler, IItemRenderer
{
    ...
    private ThermosonicBonderModel model;
    ...
    private ResourceLocation defaultThermosonicBonderTexture = new ResourceLocation(MadScience.ID, "models/" + MadFurnaces.THERMOSONIC_INTERNALNAME + "/Off.png");

    public ThermosonicBonderRender()
    {
        this.model = new ThermosonicBonderModel();
    }
    ...
    public void renderItem(ItemRenderType type, ItemStack item, Object... data)
    {
        ...
        Minecraft.getMinecraft().renderEngine.bindTexture(defaultThermosonicBonderTexture);
    ...
    public void renderTileEntityAt(TileEntity tileEntity, double x, double y, double z, float scale)
    {
        ...
        {
            // Default texture.
            bindTexture(defaultThermosonicBonderTexture);
        }
