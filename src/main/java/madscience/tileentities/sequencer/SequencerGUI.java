...
public class SequencerGUI extends GUIContainerBase
{
    ...
    public SequencerGUI(InventoryPlayer par1InventoryPlayer, SequencerEntity par2TileEntityFurnace)
    {
        ...
        TEXTURE = new ResourceLocation(MadScience.ID, "textures/gui/" + MadFurnaces.SEQUENCER_INTERNALNAME + ".png");
    }
    ...
    protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY)
    {
        ...
        String s = MadFurnaces.SEQUENCER_TILEENTITY.getLocalizedName();
        ...
        if (this.isPointInRegion(22, 36, 18, 18, mouseX, mouseY))
        {
            if (this.ENTITY.getStackInSlot(0) == null)
                this.drawTooltip(mouseX - this.guiLeft, mouseY - this.guiTop + 10, "Input DNA sample");
        }
        
        // Input empty or unsequenced genome.
        if (this.isPointInRegion(54, 36, 18, 18, mouseX, mouseY))
        {
            if (this.ENTITY.getStackInSlot(1) == null)
                this.drawTooltip(mouseX - this.guiLeft, mouseY - this.guiTop + 10, "Input data reel");
        }        
