...
public class SequencerBlock extends BlockContainer
{
    ...
    public void breakBlock(World par1World, int par2, int par3, int par4, int par5, int par6)
    {
        ...
        {
            SequencerEntity tileentityfurnace = (SequencerEntity) par1World.getBlockTileEntity(par2, par3, par4);
    ...
    {
        return MadFurnaces.SEQUENCER_TILEENTITY.blockID;
    }
    ...
    public void onBlockPlacedBy(World world, int x, int y, int z, EntityLivingBase living, ItemStack stack)
    {
        ...
        lastPlacedTileEntity = (SequencerEntity) world.getBlockTileEntity(x, y, z);
    ...
    {
        this.blockIcon = icon.registerIcon(MadScience.ID + ":" + MadFurnaces.SEQUENCER_INTERNALNAME);
    }
