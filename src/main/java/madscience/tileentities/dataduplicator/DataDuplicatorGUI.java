...
public class DataDuplicatorGUI extends GuiContainer
{
    // Texture of the GUI interface that holds all the controls.
    private static final ResourceLocation furnaceGuiTextures = new ResourceLocation(MadScience.ID, "textures/gui/" + MadFurnaces.DATADUPLICATOR_INTERNALNAME + ".png");

    // Placed tile entity in the game world.
    private DataDuplicatorEntity tileEntity;
