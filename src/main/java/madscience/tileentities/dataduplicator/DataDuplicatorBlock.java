...
public class DataDuplicatorBlock extends BlockContainer
{
    ...
    public DataDuplicatorBlock(int id)
    {
    ...
    public void breakBlock(World par1World, int par2, int par3, int par4, int par5, int par6)
    {
        ...
        {
            DataDuplicatorEntity tileentityfurnace = (DataDuplicatorEntity) par1World.getBlockTileEntity(par2, par3, par4);
    ...
    public TileEntity createNewTileEntity(World world)
    {
        ...
        return new DataDuplicatorEntity();
    }
    ...
    {
        return MadFurnaces.DATADUPLICATOR_TILEENTITY.blockID;
    }
    ...
    public void onBlockPlacedBy(World world, int x, int y, int z, EntityLivingBase living, ItemStack stack)
    {
        ...
        lastPlacedTileEntity = (DataDuplicatorEntity) world.getBlockTileEntity(x, y, z);
    ...
    {
        this.blockIcon = icon.registerIcon(MadScience.ID + ":" + MadFurnaces.DATADUPLICATOR_INTERNALNAME);
    }
