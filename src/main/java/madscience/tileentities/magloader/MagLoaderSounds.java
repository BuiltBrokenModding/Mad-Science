...
public class MagLoaderSounds
{
    ...
    static final String MAGLOADER_INSERTMAGAZINE = MadScience.ID + ":" + MadFurnaces.MAGLOADER_INTERNALNAME + ".InsertMagazine";

    // Bullets being loading into magazine sounds to play during machine progress.
    static final String MAGLOADER_LOADING = MadScience.ID + ":" + MadFurnaces.MAGLOADER_INTERNALNAME + ".Loading";

    // Played when the machine starts cooking the bullets into a loaded magazine.
    static final String MAGLOADER_PUSHSTART = MadScience.ID + ":" + MadFurnaces.MAGLOADER_INTERNALNAME + ".PushStart";

    // Played when the machine finishes loading a magazine.
    static final String MAGLOADER_PUSHSTOP = MadScience.ID + ":" + MadFurnaces.MAGLOADER_INTERNALNAME + ".PushStop";
