...
import madscience.content.items.dna.EnumDNA;
...
import madscience.content.tiles.clayfurnace.TileClayFurnace;
...
public class MadScience extends AbstractMod
{
    ...
    public void preInit(FMLPreInitializationEvent event)
    {
        ...
        metadata.authorList = Arrays.asList("Maxwolf Goodliffe", "Fox Diller");
