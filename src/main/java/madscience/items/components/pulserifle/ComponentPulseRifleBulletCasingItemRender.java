...
public class ComponentPulseRifleBulletCasingItemRender implements IItemRenderer
{
    ...
    private MadTechneModel MODEL = (MadTechneModel) AdvancedModelLoader.loadModel(MadMod.MODEL_PATH + "weaponComponents/" + MadComponents.COMPONENT_PULSERIFLEBULLETCASING_INTERNALNAME + ".mad");
    private ResourceLocation TEXTURE = new ResourceLocation(MadMod.ID, "models/weaponComponents/" + MadComponents.COMPONENT_PULSERIFLEBULLETCASING_INTERNALNAME + ".png");
