...
public class ComponentPulseRifleBulletCasingItemRender implements IItemRenderer
{
    ...
    private MadTechneModel MODEL = (MadTechneModel) AdvancedModelLoader.loadModel(MadScience.MODEL_PATH + "weaponComponents/" + MadComponents.COMPONENT_PULSERIFLEBULLETCASING_INTERNALNAME + ".mad");
    private ResourceLocation TEXTURE = new ResourceLocation(MadScience.ID, "models/weaponComponents/" + MadComponents.COMPONENT_PULSERIFLEBULLETCASING_INTERNALNAME + ".png");
