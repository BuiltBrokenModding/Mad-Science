...
public class ComponentPulseRifleGrenadeCasingItemRender implements IItemRenderer
{
    ...
    private MadTechneModel MODEL = (MadTechneModel) AdvancedModelLoader.loadModel(MadMod.MODEL_PATH + "weaponComponents/" + MadComponents.COMPONENT_PULSERIFLEGRENADECASING_INTERNALNAME + ".mad");
    private ResourceLocation TEXTURE = new ResourceLocation(MadMod.ID, "models/weaponComponents/" + MadComponents.COMPONENT_PULSERIFLEGRENADECASING_INTERNALNAME + ".png");
