...
public class ComponentPulseRifleBarrelItemRender implements IItemRenderer
{
    ...
    private IModelCustom MODEL = AdvancedModelLoader.loadModel(new ResourceLocation(MadScience.MODEL_PATH + "weaponComponents/" + ItemWeaponPart.EnumWeaponParts.BARREL.INTERNAL_NAME + ".mad"));
