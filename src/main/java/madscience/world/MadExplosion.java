        ...
        if (this.isSmoking)
        {
            ...
            while (iterator.hasNext())
            {
                ...
                if (smoking)
                {
                    ...
                    PacketDispatcher.sendPacketToAllAround(this.explosionX, this.explosionY, this.explosionZ, MadModLoader.PACKET_SEND_RADIUS, worldObj.provider.dimensionId, new MadParticlePacket("explode", (d0 + this.explosionX * 1.0D) / 2.0D, (d1 + this.explosionY * 1.0D) / 2.0D, (d2 + this.explosionZ * 1.0D) / 2.0D, d3, d4, d5).makePacket());
                    
                    //this.worldObj.spawnParticle("smoke", d0, d1, d2, d3, d4, d5);
                    PacketDispatcher.sendPacketToAllAround(this.explosionX, this.explosionY, this.explosionZ, MadModLoader.PACKET_SEND_RADIUS, worldObj.provider.dimensionId, new MadParticlePacket("smoke", d0, d1, d2, d3, d4, d5).makePacket());
                }
