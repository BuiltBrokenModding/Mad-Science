...
public final class GUIButtonTemplate
{
    /**
    ...
    private final GUIButtonTypeEnum buttonType;
    ...
    private final GUIButtonClickActionEnum clickAction;
    ...
    public GUIButtonTemplate(int buttonID,
                             GUIButtonTypeEnum buttonType,
                             GUIButtonClickActionEnum clickAction,
    ...
    public GUIButtonTypeEnum getButtonType()
    {
        return this.buttonType;
    }

    public GUIButtonClickActionEnum getClickAction()
    {
