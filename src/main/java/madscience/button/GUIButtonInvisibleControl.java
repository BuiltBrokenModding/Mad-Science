...
public class GUIButtonInvisibleControl extends GuiButton
{
    private static final ResourceLocation sandraBullock = new ResourceLocation( ModMetadata.ID,
                                                                                "textures/gui/sandraBullock.png" );

    public GUIButtonInvisibleControl(int par1, int par2, int par3, int par4, int par5)
    {
        super( par1,
               par2,
               par3,
    ...
    public void drawButton(Minecraft par1Minecraft, int par2, int par3)
    {
        if (this.drawButton)
        {
            ...
            drawTexturedQuadFit( xPosition,
                                 yPosition,
                                 width,
                                 height,
                                 zLevel );
            this.mouseDragged( par1Minecraft,
                               par2,
                               par3 );
            int l = 14737632;
