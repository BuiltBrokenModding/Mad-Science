...
import madscience.model.MadModel;
import madscience.model.MadModelPosition;
import madscience.model.MadModelScale;
import madscience.product.MadRenderingFactoryProduct;
...
public class MadRendererTemplate extends TileEntitySpecialRenderer implements ISimpleBlockRenderingHandler, IItemRenderer
{
    ...
    public boolean handleRenderType(ItemStack item, ItemRenderType type)
    {
        ...
        this.currentRenderProduct =
                MadRenderingFactory.instance().getModelInstance( MadUtils.cleanTag( item.getUnlocalizedName() ),
                                                                 true,
    ...
    private void renderMadModelAt(MadTileEntityPrefab tileEntity, double x, double y, double z, float scale)
    {
        ...
        MadRenderingFactory.instance().updateModelInstance( madTileEntity.getMachineInternalName(),
                                                            false,
        ...
        this.currentRenderProduct =
                MadRenderingFactory.instance().getModelInstance( MadUtils.cleanTag( madTileEntity.getMachineInternalName() ),
                                                                 false,
                                                                 String.valueOf( madTileEntity.xCoord ),
                                                                 String.valueOf( madTileEntity.yCoord ),
                                                                 String.valueOf( madTileEntity.zCoord ) );
        ...
        {
            bindTexture( new ResourceLocation( MadModMetadata.ID,
                                                                                                                            ...
                                                                                                                            Object... data)
    {
        ...
        MadRenderingFactory.instance().updateModelInstance( registeredMachine.getMachineName(),
                                                            true,
        ...
        // Grab rendering instance for item from rendering factory.
        this.currentRenderProduct = MadRenderingFactory.instance().getModelInstance( registeredMachine.getMachineName(),
                                                                                     true,
                                                                                     String.valueOf( item.getItemDamage() ),
                                                                                     String.valueOf( item.getMaxDamage() ) );
    ...
    public void renderTileEntityAt(TileEntity tileEntity, double x, double y, double z, float scale)
    {
        ...
        if (tileEntity instanceof MadTileEntityPrefab)
        {
            this.renderMadModelAt( (MadTileEntityPrefab) tileEntity,
                                   x,
                                   y,
                                   z,
                                   scale );
