...
public class RendererTemplate extends TileEntitySpecialRenderer implements ISimpleBlockRenderingHandler, IItemRenderer
{
    private RenderingFactoryProduct currentRenderProduct = null;
    ...
    public boolean handleRenderType(ItemStack item, ItemRenderType type)
    {
        ...
        this.currentRenderProduct =
                RenderingFactory.instance().getModelInstance( MiscUtils.cleanTag( item.getUnlocalizedName() ),
                                                              true,
    ...
    private void renderMadModelAt(TileEntityPrefab tileEntity, double x, double y, double z, float scale)
    {
        // Grab the individual tile entity in the world.
        TileEntityPrefab madTileEntity = null;
        ...
        WorldRenderInfo worldRenderInfo = madTileEntity.getEntityWorldRenderInformation();
        ...
        RenderingFactory.instance().updateModelInstance( madTileEntity.getMachineInternalName(),
                                                         false,
        ...
        this.currentRenderProduct =
                RenderingFactory.instance().getModelInstance( MiscUtils.cleanTag( madTileEntity.getMachineInternalName() ),
                                                              false,
                                                              String.valueOf( madTileEntity.xCoord ),
                                                              String.valueOf( madTileEntity.yCoord ),
                                                              String.valueOf( madTileEntity.zCoord ) );
        ...
        GL11.glTranslatef( (float) x +
                           currentRenderProduct.getModelWorldRenderInformation().getModelWorldPosition().getModelTranslateX(),
                           (float) y +
                           currentRenderProduct.getModelWorldRenderInformation().getModelWorldPosition().getModelTranslateY(),
                           (float) z +
                           currentRenderProduct.getModelWorldRenderInformation().getModelWorldPosition().getModelTranslateZ() );

        // Scale the model as according to world rendering information.
        GL11.glScalef( currentRenderProduct.getModelWorldRenderInformation().getModelWorldScale().getModelScaleX(),
        ...
        {
            bindTexture( new ResourceLocation( ModMetadata.ID,
                                               madTileEntity.getEntityTexture() ) );
        }
        else
        {
    ...
    @Override
    /** Renders a image or techne model based on master reference list from factory product data. */ public void renderItem(ItemRenderType type,
                                                                                                                            ItemStack item,
                                                                                                                            Object... data)
    {
        GL11.glPushMatrix();
        ...
        String cleanedName = MiscUtils.cleanTag( item.getUnlocalizedName() );
        TileEntityFactoryProduct registeredMachine = TileEntityFactory.instance().getMachineInfo( cleanedName );
        ...
        ModelArchive machineModels = registeredMachine.getModelArchive();
        ...
        ItemRenderInfo itemRenderInfo = machineModels.getItemRenderInfoClone();
        ...
        ModelPosition itemRenderPosition = null;
        ModelScale itemRenderScale = null;
        ...
        RenderingFactory.instance().updateModelInstance( registeredMachine.getMachineName(),
                                                         true,
        ...
        // Grab rendering instance for item from rendering factory.
        this.currentRenderProduct = RenderingFactory.instance().getModelInstance( registeredMachine.getMachineName(),
                                                                                  true,
                                                                                  String.valueOf( item.getItemDamage() ),
                                                                                  String.valueOf( item.getMaxDamage() ) );
        ...
        RenderTransformationTypes transformationToBeUndone = RenderTransformationTypes.NONE;
        switch (type)
        {
            case EQUIPPED:
            {
                // Scale
                GL11.glScalef( currentRenderProduct.getModelItemRenderInformation().getModelItemEquippedScale().getModelScaleX(),
                ...
                // Position
                GL11.glTranslatef( currentRenderProduct.getModelItemRenderInformation().getModelItemEquippedPosition().getModelTranslateX(),
                ...
                // Rotation
                GL11.glRotatef( currentRenderProduct.getModelItemRenderInformation().getModelItemEquippedRotation().getModelRotationAngle(),
                ...
                transformationToBeUndone = RenderTransformationTypes.THIRDPERSONEQUIPPED;
                break;
            }
            case EQUIPPED_FIRST_PERSON:
            {
                // Scale
                GL11.glScalef( currentRenderProduct.getModelItemRenderInformation().getModelItemFirstPersonScale().getModelScaleX(),
                ...
                // Position
                GL11.glTranslatef( currentRenderProduct.getModelItemRenderInformation().getModelItemFirstPersonPosition().getModelTranslateX(),
                ...
                // Rotation
                GL11.glRotatef( currentRenderProduct.getModelItemRenderInformation().getModelItemFirstPersonRotation().getModelRotationAngle(),
            ...
            {
                // Scale
                GL11.glScalef( currentRenderProduct.getModelItemRenderInformation().getModelItemInventoryScale().getModelScaleX(),
                ...
                // Position
                GL11.glTranslatef( currentRenderProduct.getModelItemRenderInformation().getModelItemInventoryPosition().getModelTranslateX(),
                ...
                // Rotation
                GL11.glRotatef( currentRenderProduct.getModelItemRenderInformation().getModelItemInventoryRotation().getModelRotationAngle(),
                ...
                transformationToBeUndone = RenderTransformationTypes.INVENTORY;
                break;
            }
            case ENTITY:
            {
                // Scale
                GL11.glScalef( currentRenderProduct.getModelItemRenderInformation().getModelItemEntityScale().getModelScaleX(),
                ...
                // Position
                GL11.glTranslatef( currentRenderProduct.getModelItemRenderInformation().getModelItemEntityPosition().getModelTranslateX(),
                ...
                // Rotation
                GL11.glRotatef( currentRenderProduct.getModelItemRenderInformation().getModelItemEntityRotation().getModelRotationAngle(),
                ...
                transformationToBeUndone = RenderTransformationTypes.DROPPED;
                break;
            }
            default:
                break; // never here
    ...
    public void renderTileEntityAt(TileEntity tileEntity, double x, double y, double z, float scale)
    {
        ...
        if (tileEntity instanceof TileEntityPrefab)
        {
            this.renderMadModelAt( (TileEntityPrefab) tileEntity,
                                   x,
                                   y,
                                   z,
                                   scale );
