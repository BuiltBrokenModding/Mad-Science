...
import madscience.tile.MadTileTemplatePacket;
...
public abstract class MadPackets
{
    ...
    public final Packet makePacket()
    {
        ...
        write( out );
        return PacketDispatcher.getPacket( MadModMetadata.CHANNEL_NAME,
                                           out.toByteArray() );
    }
