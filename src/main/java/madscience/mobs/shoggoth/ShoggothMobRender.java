...
public class ShoggothMobRender extends RenderLiving
{
    ...
    private static final ResourceLocation mobTexture = new ResourceLocation(MadScience.ID, "models/" + MadMobs.GMO_SHOGGOTH_INTERNALNAME + "/" + MadMobs.GMO_SHOGGOTH_INTERNALNAME + ".png");
    ...
    protected ResourceLocation getSlimeTextures(ShoggothMobEntity par1EntitySlime)
    {
        return mobTexture;
    }
    ...
    protected void scaleSlime(ShoggothMobEntity par1EntitySlime, float par2)
    {
    ...
    protected int shouldSlimeRenderPass(ShoggothMobEntity par1EntitySlime, int par2, float par3)
    {
