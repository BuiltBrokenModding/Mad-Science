...
public class MadRenderingFactoryProduct
{
    ...
    public MadRenderingFactoryProduct(MadModel renderInformation)
    {
        ...
        this.textureResource = new ResourceLocation( MadModMetadata.ID,
        ...
        for (MadModelFile productModel : renderInformation.getMachineModelsFilesClone())
        {
            this.modelRenderingReference.put( productModel.getModelName(),
                                              (MadTechneModel) AdvancedModelLoader.loadModel( productModel.getModelPath() ) );
        }
    }
    ...
    public boolean setRenderVisibilityByName(String modelName, boolean visible)
    {
        ...
        if (modelRenderingReference.containsKey( modelName ))
        {
            ...
            if (queriedModel.isVisible() != visible)
            {
                ...
                MadTechneModel replacedModel = modelRenderingReference.put( modelName,
                                                                            queriedModel );
    ...
    {
        this.modelWorldRenderInformation = new MadModelWorldRender( newWorldPosition,
                                                                    newWorldScale );
    }
}
