...
public class FBOHelper
{
    ...
    public void end()
    {
        ...
        GL11.glViewport( lastViewport.get( 0 ),
                         lastViewport.get( 1 ),
                         lastViewport.get( 2 ),
                         lastViewport.get( 3 ) );
    ...
    public void saveToFile(File file)
    {
        ...
        GL11.glPixelStorei( GL11.GL_PACK_ALIGNMENT,
                            1 );
        GL11.glPixelStorei( GL11.GL_UNPACK_ALIGNMENT,
                            1 );

        int width = GL11.glGetTexLevelParameteri( GL11.GL_TEXTURE_2D,
                                                  0,
                                                  GL11.GL_TEXTURE_WIDTH );
        int height = GL11.glGetTexLevelParameteri( GL11.GL_TEXTURE_2D,
                                                   0,
        ...
        BufferedImage image = new BufferedImage( renderTextureSize,
                                                 renderTextureSize,
    ...
    private void createFramebuffer()
    {
        ...
        GL30.glBindRenderbuffer( GL30.GL_RENDERBUFFER,
                                 depthbufferID );
