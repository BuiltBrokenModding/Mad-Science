...
import madscience.crafting.MadCraftingComponent;
import madscience.crafting.MadCraftingRecipe;
import madscience.crafting.MadCraftingRecipeTypeEnum;
...
public final class MadRecipe
{
     ...
     */
    private final HashMap<List<MadRecipeComponent[]>, MadRecipeComponent[]> smeltingList =
            new HashMap<List<MadRecipeComponent[]>, MadRecipeComponent[]>();
     ...
     */
    public static void loadCraftingRecipes(MadCraftingRecipe[] recipesToLoad,
                                           String productName,
                                           ItemStack craftingResult)
    {
        ...
        for (MadCraftingRecipe itemCraftingRecipe : recipesToLoad)
        {
            ...
            for (MadCraftingComponent recipeComponent : itemCraftingRecipe.getCraftingRecipeComponents())
            {
                ...
                ItemStack inputItem = MadRecipe.getItemStackFromString( recipeComponent.getModID(),
                                                                        recipeComponent.getInternalName(),
    ...
    public static void loadVanillaFurnaceRecipes(MadFurnaceRecipe[] madFurnaceRecipes)
    {
        ...
        for (MadFurnaceRecipe furnaceRecipe : madFurnaceRecipes)
        {
            ...
            {
                // Query game registry and vanilla blocks and items for the incoming name in an attempt to turn it into an itemstack.
                ItemStack inputItem = MadRecipe.getItemStackFromString( furnaceRecipe.getInputComponent().getModID(),
            ...
            {
                ItemStack outputItem = MadRecipe.getItemStackFromString( furnaceRecipe.getOutputComponent().getModID(),
    ...
    public static ItemStack getItemStackFromString(String modID, String itemName, int stackSize, int metaData)
    {
        ...
        if (modID.equals( MadModMetadata.ID ))
        {
            // Remove prefix from the item name if from our own project.
            itemName = MadUtils.cleanTag( itemName );
        }
