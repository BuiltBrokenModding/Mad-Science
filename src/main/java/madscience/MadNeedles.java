...
import madscience.item.ItemNeedleEmptyLogic;
import madscience.item.needles.NeedleBat;
import madscience.item.needles.NeedleCaveSpider;
import madscience.item.needles.NeedleChicken;
import madscience.item.needles.NeedleCow;
import madscience.item.needles.NeedleCreeper;
import madscience.item.needles.NeedleDirtyItem;
import madscience.item.needles.NeedleEnderman;
import madscience.item.needles.NeedleHorse;
import madscience.item.needles.NeedleMushroomCow;
import madscience.item.needles.NeedleMutant;
import madscience.item.needles.NeedleOcelot;
import madscience.item.needles.NeedlePig;
import madscience.item.needles.NeedleSheep;
import madscience.item.needles.NeedleSpider;
import madscience.item.needles.NeedleSquid;
import madscience.item.needles.NeedleVillager;
import madscience.item.needles.NeedleWitch;
import madscience.item.needles.NeedleWolf;
import madscience.item.needles.NeedleZombie;
