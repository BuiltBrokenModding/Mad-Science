...
import madscience.data.MadItemFactoryProductData;
import madscience.item.MadMetaItemData;
...
{
    private static final Map<String, MadItemFactoryProduct> registeredItems =
            new LinkedHashMap<String, MadItemFactoryProduct>();
    ...
    public MadItemFactoryProduct registerItem(MadItemFactoryProductData itemData) throws IllegalArgumentException
    {
        ...
        {
            throw new IllegalArgumentException( "Duplicate MadItemFactoryProduct '" +
    ...
    public List<MadItemFactoryProductData> getItemDataList()
    {
        ...
        Collections.sort( allItems,
                          new Comparator<MadItemFactoryProductData>()
                          {
                              @Override
                              public int compare(final MadItemFactoryProductData object1,
                                                 final MadItemFactoryProductData object2)
                              {
