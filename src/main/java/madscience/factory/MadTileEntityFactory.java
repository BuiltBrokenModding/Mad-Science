...
public class MadTileEntityFactory
{
     ...
     */
    private static final Map<String, MadTileEntityFactoryProduct> registeredMachines =
            new LinkedHashMap<String, MadTileEntityFactoryProduct>();
    /**
    ...
    public List<MadTileEntityFactoryProductData> getMachineDataList()
    {
        ...
        Collections.sort( allMachines,
                          new Comparator<MadTileEntityFactoryProductData>()
                          {
                              @Override
                              public int compare(final MadTileEntityFactoryProductData object1,
                                                 final MadTileEntityFactoryProductData object2)
                              {
     ...
     */
    public MadTileEntityFactoryProduct registerMachine(MadTileEntityFactoryProductData machineData)
            throws IllegalArgumentException
    {
        ...
        {
            throw new IllegalArgumentException( "Duplicate MadTileEntityFactoryProduct '" +
    ...
    private void checkRenderingInformation(MadTileEntityFactoryProduct tileEntityProduct)
    {
        ...
        {
            throw new IllegalArgumentException( "Cannot register MadTileEntityFactoryProduct '" +
                                                tileEntityProduct.getMachineName() +
