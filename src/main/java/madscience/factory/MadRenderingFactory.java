...
public class MadRenderingFactory
{
     ...
     */
    private static final Map<String, MadRenderingFactoryProduct> worldInstanceRenderingReference =
            new LinkedHashMap<String, MadRenderingFactoryProduct>();
    /**
    ...
    public void registerModelsToProduct(String productName, MadModel renderInformation)
    {
        ...
        if (! masterModelInformationReference.containsKey( productName ))
        {
            ...
            MadRenderingFactory.masterModelInformationReference.put( productName,
                                                                     renderInformation );
            MadModLoader.log().info( "[" + productName +
                                    ...
                                    String... renderKeyData)
    {
        ...
        if (MadRenderingFactory.worldInstanceRenderingReference.containsKey( renderKey ))
        {
            ...
            MadRenderingFactoryProduct factoryRenderProduct =
                    MadRenderingFactory.worldInstanceRenderingReference.get( renderKey );
            ...
            MadRenderingFactoryProduct updatedListing =
                    MadRenderingFactory.worldInstanceRenderingReference.put( renderKey,
    ...
    private void createNewRenderingInstance(String productName, boolean isItem, String renderKey)
    {
        ...
        if (masterModelInformationReference.containsKey( productName ))
        {
            ...
            MadModLoader.log().info( "[" + productName + "]Creating new " +
                                     renderType +
                                     " render instance with key: " +
                                     renderKey );
            MadRenderingFactory.worldInstanceRenderingReference.put( renderKey,
                                                                     new MadRenderingFactoryProduct( masterMadModelReference ) );
        }
        else
        {
