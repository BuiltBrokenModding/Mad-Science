...
public class SanitizerBlock extends BlockContainer
{
    ...
    public void breakBlock(World par1World, int par2, int par3, int par4, int par5, int par6)
    {
        ...
        {
            SanitizerEntity tileentityfurnace = (SanitizerEntity) par1World.getBlockTileEntity(par2, par3, par4);
    ...
    public void onBlockPlacedBy(World world, int x, int y, int z, EntityLivingBase living, ItemStack stack)
    {
        ...
        ENTITY = (SanitizerEntity) world.getBlockTileEntity(x, y, z);
    ...
    {
        this.blockIcon = icon.registerIcon(MadMod.ID + ":" + MadFurnaces.SANTITIZER_INTERNALNAME);
    }
