...
import madscience.model.MadModelData;
...
public class MadTileTemplatePacket extends MadPackets
{
    ...
    public void execute(EntityPlayer player, Side side) throws ProtocolException
    {
        ...
        if (side.isClient())
        {
            ...
            // Energy.
            this.madTileEntity.setEnergy( ForgeDirection.UNKNOWN,
                                          lastEnergy );
            ...
            for (String splitServerModel : splitServerModelCompressesdData)
            {
                ...
                this.madTileEntity.setModelWorldRenderVisibilityByName( modelName,
                                                                        MadUtils.convertByteToBoolean( modelVisible ) );
            }
            ...
            MadModelPosition receivedPosition = new MadModelPosition( floatRenderPosition[0],
                                                                      floatRenderPosition[1],
                                                                      floatRenderPosition[2] );

            // Create scale object from received data.
            MadModelScale receivedScale = new MadModelScale( floatRenderScale[0],
                                                             floatRenderScale[1],
                                                             floatRenderScale[2] );
