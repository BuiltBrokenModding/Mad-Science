...
public abstract class TileEntityPrefab extends TileEntityModelSyncPrefab
{
    /**
    ...
    public TileEntityPrefab(TileEntityFactoryProduct registeredMachine)
    {
        super( registeredMachine );
    }

    public TileEntityPrefab(String machineName)
    {
        super();
    }
    ...
    public void updateSound()
    {
        ...
        {
            this.registeredMachine.playTriggerSound( SoundTriggerEnum.WORKSTART,
                                                     this.xCoord,
                                                     this.yCoord,
                                                     this.zCoord,
                                                     this.worldObj );
        ...
        {
            this.registeredMachine.playTriggerSound( SoundTriggerEnum.WORKING,
                                                     this.xCoord,
                                                     this.yCoord,
                                                     this.zCoord,
                                                     this.worldObj );
        ...
        {
            this.registeredMachine.playTriggerSound( SoundTriggerEnum.WORKEND,
                                                     this.xCoord,
                                                     this.yCoord,
                                                     this.zCoord,
                                                     this.worldObj );
        ...
        if (! this.canSmelt() && ! this.isPowered() &&
            worldObj.getWorldTime() % MiscUtils.SECOND_IN_TICKS == 0L)
        {
            this.registeredMachine.playTriggerSound( SoundTriggerEnum.IDLEOFF,
                                                     this.xCoord,
                                                     this.yCoord,
                                                     this.zCoord,
                                                     this.worldObj );
        ...
        if (this.canSmelt() && this.isPowered() &&
            worldObj.getWorldTime() % MiscUtils.SECOND_IN_TICKS == 0L)
        {
            this.registeredMachine.playTriggerSound( SoundTriggerEnum.IDLEON,
                                                     this.xCoord,
                                                     this.yCoord,
                                                     this.zCoord,
                                                     this.worldObj );
    ...
    public void initiate()
    {
        ...
        this.registeredMachine = TileEntityFactory.instance().getMachineInfo( this.getMachineInternalName() );
    }
    ...
    {
        // Right Click Sound
        this.registeredMachine.playTriggerSound( SoundTriggerEnum.RIGHTCLICK,
                                                 this.xCoord,
                                                 this.yCoord,
                                                 this.zCoord,
                                                 this.worldObj );
        ...
        par5EntityPlayer.openGui( ForgeMod.instance,
    ...
    {
        // Left Click Sound
        this.registeredMachine.playTriggerSound( SoundTriggerEnum.LEFTCLICK,
                                                 this.xCoord,
                                                 this.yCoord,
                                                 this.zCoord,
                                                 this.worldObj );
