...
public class CryotubeGUI extends MadGUITemplate
{
    ...
    public CryotubeGUI(InventoryPlayer par1InventoryPlayer, CryotubeEntity par2TileEntityFurnace)
    {
        ...
        TEXTURE = new ResourceLocation(MadScience.ID, "textures/gui/" + MadMachines.CRYOTUBE_INTERNALNAME + ".png");
    }
    ...
    protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY)
    {
        ...
        String s = MadMachines.CRYOTUBE_TILEENTITY.getLocalizedName();
