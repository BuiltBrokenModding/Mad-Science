...
public class SoniclocatorGUI extends MadGUITemplate
{
    ...
    public SoniclocatorGUI(InventoryPlayer par1InventoryPlayer, SoniclocatorEntity par2TileEntityFurnace)
    {
        ...
        TEXTURE = new ResourceLocation(MadScience.ID, "textures/gui/" + MadMachines.SONICLOCATOR_INTERNALNAME + ".png");
    }
    ...
    protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY)
    {
        ...
        String s = MadMachines.SONICLOCATOR_TILEENTITY.getLocalizedName();
    ...
    public void actionPerformed(GuiButton button)
    {
        ...
        if (button.id == 1 && Desktop.isDesktopSupported())
        {
            ...
            else
            {
                try
                {
                    this.passClick(new URI(MadConfig.SONICLOCATOR_HELP));
                }
                catch (Exception err)
                {
