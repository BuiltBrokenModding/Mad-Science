...
public class ClayfurnaceRecipes
{
    ...
    {
        ClayfurnaceRecipes.smeltingList.put(Integer.valueOf(par1), par2ItemStack);
        ClayfurnaceRecipes.experienceList.put(Integer.valueOf(par2ItemStack.itemID), Float.valueOf(par3));
    }
    ...
    {
        return ClayfurnaceRecipes.smeltingList;
    }
}
