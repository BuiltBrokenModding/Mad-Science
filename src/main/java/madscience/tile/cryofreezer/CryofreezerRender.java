...
public class CryofreezerRender extends TileEntitySpecialRenderer implements ISimpleBlockRenderingHandler, IItemRenderer
{
    ...
    private MadTechneModel MODEL = (MadTechneModel) AdvancedModelLoader.loadModel(MadMod.MODEL_PATH + MadFurnaces.CRYOFREEZER_INTERNALNAME + "/" + MadFurnaces.CRYOFREEZER_INTERNALNAME + ".mad");
    private ResourceLocation TEXTURE = new ResourceLocation(MadMod.ID, "models/" + MadFurnaces.CRYOFREEZER_INTERNALNAME + "/idle.png");
