...
public class SequencerRender extends TileEntitySpecialRenderer implements ISimpleBlockRenderingHandler, IItemRenderer
{
    ...
    private MadTechneModel MODEL = (MadTechneModel) AdvancedModelLoader.loadModel(MadScience.MODEL_PATH + MadMachines.SEQUENCER_INTERNALNAME + "/" + MadMachines.SEQUENCER_INTERNALNAME + ".mad");
    ...
    private ResourceLocation TEXTURE = new ResourceLocation(MadScience.ID, "models/" + MadMachines.SEQUENCER_INTERNALNAME + "/idle.png");
    ...
    private void renderAModelAt(SequencerEntity tileEntity, double x, double y, double z, float f)
    {
        ...
        if (lastPlacedTileEntity != null && lastPlacedTileEntity.sequencerTexture != null && !lastPlacedTileEntity.sequencerTexture.isEmpty())
        {
            // Apply our custom texture from asset directory.
            bindTexture(new ResourceLocation(MadScience.ID, lastPlacedTileEntity.sequencerTexture));
        }
        else
        {
    ...
    {
        this.renderAModelAt((SequencerEntity) tileEntity, x, y, z, scale);
    }
