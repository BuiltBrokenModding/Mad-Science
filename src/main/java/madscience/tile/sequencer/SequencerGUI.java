...
public class SequencerGUI extends MadGUITemplate
{
    ...
    public SequencerGUI(InventoryPlayer par1InventoryPlayer, SequencerEntity par2TileEntityFurnace)
    {
        ...
        TEXTURE = new ResourceLocation(MadScience.ID, "textures/gui/" + MadMachines.SEQUENCER_INTERNALNAME + ".png");
    }
    ...
    protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY)
    {
        ...
        String s = MadMachines.SEQUENCER_TILEENTITY.getLocalizedName();
