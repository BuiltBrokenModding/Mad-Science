...
import madscience.slot.MadInputSlot;
import madscience.slot.MadOutputSlot;
    ...
    public MadTileTemplateContainer(InventoryPlayer entityPlayer, MadTileEntityPrefab tileEntity)
    {
        ...
        for (int i = 0; i < CONTAINERS.length; i++)
        {
            ...
            if (slotContainer.getSlotType().name().toLowerCase().contains( "input" ))
            {
                ...
                this.addSlotToContainer( new MadInputSlot( tileEntity,
                                                           slotContainer.slot(),
            ...
            else if (slotContainer.getSlotType().name().toLowerCase().contains( "output" ))
            {
                ...
                this.addSlotToContainer( new MadOutputSlot( entityPlayer.player,
                                                            tileEntity,
                                                            slotContainer.slot(),
                                                            slotContainer.offsetX(),
                                                            slotContainer.offsetY(),
