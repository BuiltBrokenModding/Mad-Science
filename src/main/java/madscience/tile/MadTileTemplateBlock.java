...
import madscience.model.MadModelBounds;
...
public class MadTileTemplateBlock extends BlockContainer
{
    ...
    public void breakBlock(World par1World, int par2, int par3, int par4, int par5, int par6)
    {
        ...
        if (vanillaTileInstance != null && vanillaTileInstance instanceof MadTileEntityPrefab)
        {
            ...
            {
                this.registeredProduct.playTriggerSound( MadSoundTriggerEnum.DESTROYED,
                                                         par2,
                                                         par3,
                                                         par4,
                                                         par1World );
    ...
    public void onBlockPlacedBy(World world, int x, int y, int z, EntityLivingBase living, ItemStack stack)
    {
        ...
        if (vanillaTileInstance != null && vanillaTileInstance instanceof MadTileEntityPrefab)
        {
            ...
            if (tileEntityInstance != null)
            {
                if (this.registeredProduct != null)
                {
                    this.registeredProduct.playTriggerSound( MadSoundTriggerEnum.CREATED,
                                                             x,
                                                             y,
                                                             z,
                                                             world );
    ...
    {
        this.blockIcon = icon.registerIcon( MadModMetadata.ID + ":" +
