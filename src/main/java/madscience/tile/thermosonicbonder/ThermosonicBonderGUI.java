...
public class ThermosonicBonderGUI extends MadGUITemplate
{
    ...
    public ThermosonicBonderGUI(InventoryPlayer par1InventoryPlayer, ThermosonicBonderEntity par2TileEntityFurnace)
    {
        ...
        TEXTURE = new ResourceLocation(MadScience.ID, "textures/gui/" + MadMachines.THERMOSONIC_INTERNALNAME + ".png");
    }
    ...
    protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY)
    {
        ...
        String s = MadMachines.THERMOSONIC_TILEENTITY.getLocalizedName();
