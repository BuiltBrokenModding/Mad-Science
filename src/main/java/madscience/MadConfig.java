...
public class MadConfig
{
    ...
    public static @CfgMobs int GENETICALLYMODIFIED_MONSTERPLACER = GENETICALLYMODIFIED_MONSTERPLACER_DEFAULT;

    // CombinedGenomeMonsterPlacer
    public final static int COMBINEDGENOME_MONSTERPLACER_DEFAULT = ++madItemIDs;
    public static @CfgGenomes int COMBINEDGENOME_MONSTERPLACER = COMBINEDGENOME_MONSTERPLACER_DEFAULT;
    
    // CombinedMemoryMonsterPlacer
    public final static int COMBINEDMEMORY_MONSTERPLACER_DEFAULT = ++madItemIDs;
    public static @CfgMemories int COMBINEDMEMORY_MONSTERPLACER = COMBINEDMEMORY_MONSTERPLACER_DEFAULT;
    ...
    public static @CfgMobs int GMO_WEREWOLF_METAID = GMO_WEREWOLF_METAID_DEFAULT;
    public static @CfgProcessing int GMO_WEREWOLF_COOKTIME = COOKTIME_DEFAULT;
    
    // Disgusting Meatcube [Slime + Pig,Cow,Chicken]
    public final static int GMO_MEATCUBE_METAID_DEFAULT = ++madGMOMobIDs;
    public static @CfgMobs int GMO_MEATCUBE_METAID = GMO_MEATCUBE_METAID_DEFAULT;
    public static @CfgProcessing int GMO_MEATCUBE_COOKTIME = COOKTIME_DEFAULT;
    
    // Creeper Cow [Creeper + Cow]
    public final static int GMO_CREEPERCOW_METAID_DEFAULT = ++madGMOMobIDs;
    public static @CfgMobs int GMO_CREEPERCOW_METAID = GMO_CREEPERCOW_METAID_DEFAULT;
    public static @CfgProcessing int GMO_CREEPERCOW_COOKTIME = COOKTIME_DEFAULT;
    ...
    public static @CfgMobs int GMO_WOOLYCOW_METAID = GMO_WOOLYCOW_METAID_DEFAULT;
    public static @CfgProcessing int GMO_WOOLYCOW_COOKTIME = COOKTIME_DEFAULT;
    ...
    public static @CfgMobs int GMO_SHOGGOTH_METAID = GMO_SHOGGOTH_METAID_DEFAULT;
    public static @CfgProcessing int GMO_SHOGGOTH_COOKTIME = COOKTIME_DEFAULT;
    ...
    public static @CfgMobs int GMO_ABOMINATION_METAID = GMO_ABOMINATION_METAID_DEFAULT;
    public static @CfgProcessing int GMO_ABOMINATION_COOKTIME = COOKTIME_DEFAULT;
    ...
    public static @CfgMobs int GMO_WITHERSKELETON_METAID = GMO_WITHERSKELETON_METAID_DEFAULT;
    public static @CfgProcessing int GMO_WITHERSKELETON_COOKTIME = COOKTIME_DEFAULT;
    
    // Villager Zombie [Villager + Zombie]
    public final static int GMO_VILLAGERZOMBIE_METAID_DEFAULT = ++madGMOMobIDs;
    public static @CfgMobs int GMO_VILLAGERZOMBIE_METAID = GMO_VILLAGERZOMBIE_METAID_DEFAULT;
    public static @CfgProcessing int GMO_VILLAGERZOMBIE_COOKTIME = COOKTIME_DEFAULT;
    
    // Skeleton Horse [Horse + Skeleton]
    public final static int GMO_SKELETONHORSE_METAID_DEFAULT = ++madGMOMobIDs;
    public static @CfgMobs int GMO_SKELETONHORSE_METAID = GMO_SKELETONHORSE_METAID_DEFAULT;
    public static @CfgProcessing int GMO_SKELETONHORSE_COOKTIME = COOKTIME_DEFAULT;
    
    // Zombie Horse [Zombie + Horse]
    public final static int GMO_ZOMBIEHORSE_METAID_DEFAULT = ++madGMOMobIDs;
    public static @CfgMobs int GMO_ZOMBIEHORSE_METAID = GMO_ZOMBIEHORSE_METAID_DEFAULT;
    public static @CfgProcessing int GMO_ZOMBIEHORSE_COOKTIME = COOKTIME_DEFAULT;
    ...
    public static @CfgMobs int GMO_ENDERSQUID_METAID = GMO_ENDERSQUID_METAID_DEFAULT;
    public static @CfgProcessing int GMO_ENDERSQUID_COOKTIME = COOKTIME_DEFAULT;
    ...
    public final static int MAINFRAME_COMPONENTS_DEFAULT = ++madItemIDs;
    public static @CfgId int MAINFRAME_COMPONENTS = MAINFRAME_COMPONENTS_DEFAULT;
    ...
    // Liquid Bucket DNA
    public final static int EXAMPLE_FLUID_BUCKET_DEFAULT = ++madItemIDs;
    public static @CfgId
    int LIQUIDDNA_BUCKET = EXAMPLE_FLUID_BUCKET_DEFAULT;
    ...
    public static @CfgId(block = true) int DNA_EXTRACTOR = DNA_EXTRACTOR_DEFAULT;
    ...
    public static @CfgId(block = true) int SANTITIZER = SANTITIZER_DEFAULT;
    ...
    public static @CfgId(block = true) int MAINFRAME = MAINFRAME_DEFAULT;
    ...
    public static @CfgId(block = true) int GENE_SEQUENCER = GENE_SEQUENCER_DEFAULT;
    ...
    public static @CfgId(block = true) int CRYOFREEZER = CRYOFREEZER_DEFAULT;
    ...
    public static @CfgId(block = true) int INCUBATOR = INCUBATOR_DEFAULT;
    ...
    public static @CfgId(block = true) int MEATCUBE = MEATCUBE_DEFAULT;
    
    // Cryogenic Tube
    public final static int CRYOTUBE_DEFAULT = ++madBlockIDs;
    public static @CfgId(block = true) int CRYOTUBE = CRYOTUBE_DEFAULT;
    ...
    public static @CfgId(block = true) int CRYOTUBEGHOST = CRYOTUBEGHOST_DEFAULT;
    
    // Thermosonic Bonder
    public final static int THERMOSONIC_DEFAULT = ++madBlockIDs;
    public static @CfgId(block = true) int THERMOSONIC = THERMOSONIC_DEFAULT;
    ...
    public static @CfgId(block = true) int DATADUPLICATOR = DATADUPLICATOR_DEFAULT;
    ...
    public static void load(Configuration config)
    {
        try
        {
            ...
            for (Field field : fields)
            {
                ...
                if (annoCPUTime == null && annoBlock != null && annoBool == null && annoInt == null && annoMobs == null && annoGenomes == null && annoDNA == null && annoNeedles == null && annoEnergy == null)
                {
                ...
                else if (annoCPUTime == null && annoBlock == null && annoBool == null && annoInt == null && annoMobs == null && annoGenomes == null && annoDNA == null && annoNeedles == null && annoEnergy != null)
                {
