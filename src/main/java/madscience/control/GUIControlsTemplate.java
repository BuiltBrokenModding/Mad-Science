...
public final class GUIControlsTemplate
{
    ...
    private final GUIControlTypeEnum controlType;

    public GUIControlsTemplate(GUIControlTypeEnum controlType,
                               int screenX,
                               int screenY,
                               int fillX,
                               int fillY,
    ...
    public GUIControlTypeEnum getControlType()
    {
