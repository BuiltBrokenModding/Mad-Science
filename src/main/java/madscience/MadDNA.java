...
import madscience.item.dna.DNABat;
import madscience.item.dna.DNACaveSpider;
import madscience.item.dna.DNAChicken;
import madscience.item.dna.DNACow;
import madscience.item.dna.DNACreeper;
import madscience.item.dna.DNAEnderman;
import madscience.item.dna.DNAGhast;
import madscience.item.dna.DNAHorse;
import madscience.item.dna.DNAMushroomCow;
import madscience.item.dna.DNAOcelot;
import madscience.item.dna.DNAPig;
import madscience.item.dna.DNASheep;
import madscience.item.dna.DNASkeleton;
import madscience.item.dna.DNASlime;
import madscience.item.dna.DNASpider;
import madscience.item.dna.DNASquid;
import madscience.item.dna.DNAVillager;
import madscience.item.dna.DNAWitch;
import madscience.item.dna.DNAWolf;
import madscience.item.dna.DNAZombie;
