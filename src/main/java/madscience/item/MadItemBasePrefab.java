...
abstract class MadItemBasePrefab extends Item
{
    ...
    public void addInformation(ItemStack par1ItemStack, EntityPlayer par2EntityPlayer, List info, boolean par4)
    {
        ...
        {
            info.addAll( MadUtils.splitStringPerWord( tooltip,
                                                      5 ) );
        }
        else if (defaultTooltip != null && defaultTooltip.length() > 0 &&
                 tooltip != null && tooltip.length() > 0 && ! isShiftPressed)
        {
            info.addAll( MadUtils.splitStringPerWord( String.valueOf( defaultTooltip ),
                                                      10 ) );
        }
    }
    ...
    public int getRenderPasses(int metadata)
    {
        ...
        MadItemFactoryProduct referenceItemProduct =
                MadItemFactory.instance().getItemInfo( this.getRegisteredItemBaseName() );
    ...
    public String getUnlocalizedName(ItemStack stack)
    {
        ...
        MadItemFactoryProduct referenceItemProduct =
                MadItemFactory.instance().getItemInfo( madStack.getRegisteredItemBaseName() );
            ...
            for (MadMetaItemData subItem : subItemsArray)
            {
                ...
                for (MadItemRenderPass renderPassObject : itemRenderPasses)
                {
                    ...
                    clientRegisteredIcons.put( subItem.getItemName() + "_" +
                                               ...
                                               iconRegistry.registerIcon( MadModMetadata.ID +
                                                                          ":" +
