...
public class UnregisteredItem
{
    ...
    private SubItemsArchive[] subItemsArchive;
    ...
    public UnregisteredItem(String itemBaseName,
                            boolean noRepair,
                            int maxDamage,
                            int maxStacksize,
                            int damageVSEntity,
                            ...
                            SubItemsArchive[] subItemsArchive)
    {
        super();
    ...
    public SubItemsArchive[] getSubItemsArchive()
    {
        return subItemsArchive;
    }

    public void setSubItemsArchive(SubItemsArchive[] subItemsArchive)
    {
        this.subItemsArchive = subItemsArchive;
    }
}
