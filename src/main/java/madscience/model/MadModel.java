...
import madscience.rendering.MadModelItemRender;
import madscience.rendering.MadModelWorldRender;
...
public class MadModel
{
    ...
    public MadModel(MadModelFile[] machineModels,
    ...
    public static MadModelWorldRender defaultWorldRenderInfo()
    {
        ...
        MadModelWorldRender tmpWorldRenderInfo = new MadModelWorldRender( new MadModelPosition( 0.5F,
                                                                                                0.5F,
                                                                                                0.5F ),
                                                                          new MadModelScale( 1.0F,
                                                                                             1.0F,
                                                                                             1.0F ) );
    ...
    public static MadModelItemRender defaultItemRenderInfo()
    {
        ...
        MadModelItemRender tmpItemInfo = new MadModelItemRender( true,
                                                                 true,
                                                                 true,
                                                                 true,
                                                                 new MadModelScale( 1.4F,
                                                                                    1.4F,
                                                                                    1.4F ),
                                                                 // EQUIPPED
                                                                 new MadModelPosition( 0.1F,
                                                                                       0.3F,
                                                                                       0.3F ),
                                                                 new MadModelRotation( 90.0F,
                                                                                       0.0F,
                                                                                       1.0F,
                                                                                       0.0F ),
                                                                 new MadModelScale( 1.0F,
                                                                 ...
                                                                 new MadModelScale( 1.0F,
                                                                                    ...
                                                                                    1.0F ),
                                                                 // INVENTORY
                                                                 new MadModelPosition( 0.5F,
                                                                                       0.42F,
                                                                                       0.5F ),
                                                                 new MadModelRotation( 270.0F,
                                                                                       0.0F,
                                                                                       0.5F,
                                                                                       0.0F ),
                                                                 new MadModelScale( 1.0F,
                                                                                    ...
                                                                                    1.0F ),
                                                                 // ENTITY
                                                                 new MadModelPosition( 0.0F,
                                                                                       0.0F,
                                                                                       0.0F ),
                                                                 new MadModelRotation( 180.0F,
                                                                                       0.0F,
                                                                                       1.0F,
                                                                                       0.0F ) );
    ...
    public MadModelData[] getMachineModelsDataClone()
    {
        ...
        {
            modelData[x] = new MadModelData( modelReference.isModelVisible(),
    ...
    public MadModelFile[] getMachineModelsFilesClone()
    {
        ...
        for (MadModelFile modelReference : this.machineModels)
        {
            modelData[x] = new MadModelFile( modelReference.getModelPath(),
    ...
    {
        MadModelItemRender renderItem = new MadModelItemRender( itemRenderInfo.isRenderItemEntity3D(),
                                                                itemRenderInfo.isRenderItemEquipped3D(),
                                                                itemRenderInfo.isRenderItemFirstPerson3D(),
                                                                itemRenderInfo.isRenderItemInventory3D(),
                                                                new MadModelScale( itemRenderInfo.getModelItemEquippedScale().getModelScaleX(),
                                                                                   // EQUIPPED
                                                                                   itemRenderInfo.getModelItemEquippedScale().getModelScaleY(),
                                                                                   itemRenderInfo.getModelItemEquippedScale().getModelScaleZ() ),
                                                                new MadModelPosition( itemRenderInfo.getModelItemEquippedPosition().getModelTranslateX(),
                                                                ...
                                                                new MadModelRotation( itemRenderInfo.getModelItemEquippedRotation().getModelRotationAngle(),
                                                                ...
                                                                new MadModelScale( itemRenderInfo.getModelItemFirstPersonScale().getModelScaleX(),
                                                                                   // FIRST_PERSON
                                                                                   itemRenderInfo.getModelItemFirstPersonScale().getModelScaleY(),
                                                                                   itemRenderInfo.getModelItemFirstPersonScale().getModelScaleZ() ),
                                                                new MadModelPosition( itemRenderInfo.getModelItemFirstPersonPosition().getModelTranslateX(),
                                                                ...
                                                                new MadModelRotation( itemRenderInfo.getModelItemFirstPersonRotation().getModelRotationAngle(),
                                                                ...
                                                                new MadModelScale( itemRenderInfo.getModelItemInventoryScale().getModelScaleX(),
                                                                                   // INVENTORY
                                                                                   itemRenderInfo.getModelItemInventoryScale().getModelScaleY(),
                                                                                   itemRenderInfo.getModelItemInventoryScale().getModelScaleZ() ),
                                                                new MadModelPosition( itemRenderInfo.getModelItemInventoryPosition().getModelTranslateX(),
                                                                ...
                                                                new MadModelRotation( itemRenderInfo.getModelItemInventoryRotation().getModelRotationAngle(),
                                                                ...
                                                                new MadModelScale( itemRenderInfo.getModelItemEntityScale().getModelScaleX(),
                                                                                   // ENTITY
                                                                                   itemRenderInfo.getModelItemEntityScale().getModelScaleY(),
                                                                                   itemRenderInfo.getModelItemEntityScale().getModelScaleZ() ),
                                                                new MadModelPosition( itemRenderInfo.getModelItemEntityPosition().getModelTranslateX(),
                                                                                      itemRenderInfo.getModelItemEntityPosition().getModelTranslateY(),
                                                                                      itemRenderInfo.getModelItemEntityPosition().getModelTranslateZ() ),
                                                                new MadModelRotation( itemRenderInfo.getModelItemEntityRotation().getModelRotationAngle(),
    ...
    {
        MadModelWorldRender renderWorld =
                new MadModelWorldRender( new MadModelPosition( worldRenderInfo.getModelWorldPosition().getModelTranslateX(),
                                                               worldRenderInfo.getModelWorldPosition().getModelTranslateY(),
                                                               worldRenderInfo.getModelWorldPosition().getModelTranslateZ() ),
                                         new MadModelScale( worldRenderInfo.getModelWorldScale().getModelScaleX(),
