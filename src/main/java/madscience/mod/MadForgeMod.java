...
@Mod(modid = MadModMetadata.ID,
     name = MadModMetadata.NAME,
     version = MadModMetadata.VERSION_FULL,
     useMetadata = false,
     acceptedMinecraftVersions = MadModMetadata.MINECRAFT_VERSION,
     dependencies = MadModMetadata.DEPENDENCIES)
@NetworkMod(channels = {MadModMetadata.CHANNEL_NAME},
            packetHandler = MadPacketHandler.class,
...
public class MadForgeMod
{
    ...
    @SidedProxy(clientSide = MadModMetadata.CLIENT_PROXY,
                serverSide = MadModMetadata.SERVER_PROXY)
    ...
    public void preInit(FMLPreInitializationEvent event) // NO_UCD (unused code)
    {
        ...
        MadModLoader.setLog( event.getModLog(),
                             FMLLog.getLogger() );
        ...
        metadata.version = MadModMetadata.VMAJOR + "." + MadModMetadata.VMINOR +
    ...
    {
        return MadModMetadata.ID.equals( "mineapi" );
    }
    ...
    public void init(FMLInitializationEvent event) // NO_UCD (unused code)
    {
        ...
        NetworkRegistry.instance().registerGuiHandler( MadForgeMod.instance,
                                                       MadForgeMod.guiHandler );
    ...
    private void recipeTileEntity()
    {
        ...
        for (Iterator iterator = registeredMachines.iterator(); iterator.hasNext(); )
        {
            ...
            if (registeredMachine != null)
            {
                ...
                MadRecipe.loadCraftingRecipes( registeredMachine.getCraftingRecipe(),
    ...
    private void recipeItems()
    {
        ...
        for (Iterator iterator = registeredItems.iterator(); iterator.hasNext(); )
        {
            ...
            if (registeredItem != null)
            {
                ...
                {
                    MadRecipe.loadCraftingRecipes( subItem.getCraftingRecipes(),
                                                   subItem.getItemName(),
