...
import madscience.creativetab.MadCreativeTab;
...
public class MadModLoader
{
    ...
    static
    {
        ...
        String expectedFilename = MadModMetadata.ID + ".json";
    ...
    {
        return new MadModData( MadModMetadata.ID,
                               MadModMetadata.NAME,
    ...
    {
        ItemStack possibleItem = MadRecipe.getItemStackFromString( MadModMetadata.ID,
                                                                   data.getCreativeTabIconName(),
                                                                   1,
                                                                   data.getCreativeTabIconMetadata() );
