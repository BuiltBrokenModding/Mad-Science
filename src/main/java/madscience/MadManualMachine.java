...
//        machineGUIControls.add(new MadGUIControl(MadGUIControlTypeEnum.CookingProgressX, 72, 15, 176, 0, 28, 28));
...
//                new MadModelPosition(0.5F, 0.34F, 0.5F),
//                new MadModelScale(0.6F, 0.68F, 0.6F));
//        
//        // MODELS AND TEXTURE
//        MadModel machineModel = new MadModel(
//                madchineModels.toArray(new MadModelFile[]{}),
//                "models/clayFurnace/idle.png",
//                itemRenderer,
//                worldRenderer);
//        
//        // RESULT
