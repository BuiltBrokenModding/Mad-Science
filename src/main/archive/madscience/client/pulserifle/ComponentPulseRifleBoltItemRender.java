...
public class ComponentPulseRifleBoltItemRender implements IItemRenderer
{
    ...
    private IModelCustom MODEL = AdvancedModelLoader.loadModel(new ResourceLocation(MadScience.MODEL_PATH + "weaponComponents/" + ItemWeaponPart.EnumWeaponParts.BOLT.INTERNAL_NAME + ".mad"));
