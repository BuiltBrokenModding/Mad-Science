package madscience.client.pulserifle;
...
public class ComponentPulseRifleGrenadeCasingItemRender implements IItemRenderer
{
    ...
    private IModelCustom MODEL = AdvancedModelLoader.loadModel(new ResourceLocation(MadScience.MODEL_PATH + "weaponComponents/" + ItemWeaponPart.EnumWeaponParts.GRENADE_CASING.INTERNAL_NAME + ".mad"));
    private ResourceLocation TEXTURE = new ResourceLocation(MadScience.ID, "models/weaponComponents/" + ItemWeaponPart.EnumWeaponParts.GRENADE_CASING.INTERNAL_NAME + ".png");
