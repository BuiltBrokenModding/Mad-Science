...
public class ComponentPulseRifleTriggerItemRender implements IItemRenderer
{
    ...
    private IModelCustom MODEL = AdvancedModelLoader.loadModel(new ResourceLocation(MadScience.MODEL_PATH + "weaponComponents/" + ItemWeaponPart.EnumWeaponParts.TRIGGER.INTERNAL_NAME + ".mad"));
    ...
    public void renderItem(ItemRenderType type, ItemStack item, Object... data)
    {
        ...
        switch (type)
        {
            ...
            case INVENTORY:
            {
                float scale = 0.48F;
                GL11.glScalef(scale, scale, scale);
                GL11.glTranslatef(-0.55F, -0.5F, 0.0F);
